...
public class controlador_usuario implements Initializable {
    ...
    private void abrir(ActionEvent event) {
        System.out.println("Abrir favoritos - pendiente");
        // Se implementará cuando tengamos controlador_deseos
    }

    @FXML
    private void abrircarrito(ActionEvent event) {
        System.out.println("Abrir carrito - pendiente");
        // Se implementará cuando tengamos controlador_carrito
    }

    @FXML
    private void abrirhistorial(ActionEvent event) {
        System.out.println("Abrir historial - pendiente");
        // Se implementará cuando tengamos controlador_historial
    }
